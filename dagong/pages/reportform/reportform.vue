	...
	<view class=" bg-white" style=''>
			...
			<view class="cu-card case  bg-white" >
				...
				<view class="flex  p-xs margin-bottom-sm mb-sm">
					<view class="flex-treble  padding-sm margin-xs radius" style="float: left;margin-left: 60px;">
						<view class="name">0</view>
						<view class="manager" style="font-size: 15px;">成交数</view>
					</view>
					<view class="flex-treble  padding-sm margin-xs radius"  style="float: left;margin-left: 50px;">
						<view class="name">0</view>
						<view class="manager" style="font-size: 15px;">库存数</view>
					</view>
					<view class="flex-treble  padding-sm margin-xs radius"  style="float: left;margin-left: 50px;">
						<view class="name">0</view>
						<view class="manager" style="font-size: 15px;">采购数</view>
					</view>
				</view>
			</view>
		<view class="cu-card case  bg-white"  style="margin-top: 90px;">
			<view class="qiun-charts" style="">
				<canvas canvas-id="canvasColumn" id="canvasColumn" class="charts"></canvas>
			</view>
			<view class="qiun-title-bar" style="">
				<view class="qiun-title-dot-light" style="text-align: center;font-size: 15px;">年度成交业绩统计</view>
			</view>
		</view>
	</view>
</template>
