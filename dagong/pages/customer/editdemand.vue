	...
	<view style="overflow:auto;overflow-x: hidden">
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<input style="width: 120px;" class="" type="text" placeholder="请输入" placeholder-class="placeholder" />
				<input style="width: 120px;" class="" type="text" placeholder="请输入" placeholder-class="placeholder" />
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b">
				...
				<input class="desc" type="text" placeholder="例如品牌/空间/舒适度" placeholder-class="placeholder" />
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">车体形式</text>
				<input class="desc" type="text" placeholder="例如SUV/MPV/跑车" placeholder-class="placeholder" />
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b">
				...
				<input class="desc" type="text" placeholder="例如自己/老婆/老公" placeholder-class="placeholder" />
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">决定人到过店</text>
			...
			<view class="yt-list-cell b-b">
				...
				<input class="desc" type="text" placeholder="" placeholder-class="placeholder" />
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b">
				...
				<textarea class="desc" type="text" placeholder="" placeholder-class="placeholder" />
			</view>
		</view>
	...
	export default {
		data() {
			...
			return {
				...
				type:["选择","是","否","不确定"],
				typeIndex:0,
				type2:["选择","资金到位","资金不足","尚不明确"],
				type2Index:0,
				type3:["不限","1年内","2年内","3年内","4年内","5年内","6年内","7年内","8年内","9年内","10年内"],
				type3Index:0,
				date: currentDate,
				time: '12:01',
				date1: currentDate1,
