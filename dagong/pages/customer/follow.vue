	...
	<view style="overflow:auto;overflow-x: hidden">
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">跟进类型</text>
				<radio class="radio" type="radio" name="car_type1" value="1" :checked="bianhao1==='1'" @click="radio1('1')"/><text style="font-size: 15px;">买车需求</text>
				<radio class="radio" type="radio" name="car_type1" value="2" :checked="bianhao1==='2'" @click="radio1('2')"/><text style="font-size: 15px;">卖车需求</text>
			</view>
		</view>
		<view class="">
