	...
	<view style="overflow:auto;overflow-x: hidden">
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">类型</text>
				<radio class="radio" type="radio" name="car_type1" value="1" :checked="bianhao1==='1'" @click="radio1('1')"/><text style="font-size: 15px;">销售款</text>
				<radio class="radio" type="radio" name="car_type1" value="2" :checked="bianhao1==='2'" @click="radio1('2')"/><text style="font-size: 15px;">其他款项</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">收款金额</text>
				<input class="desc" type="text" placeholder="请输入" placeholder-class="placeholder" />元
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">收款方式</text>
			...
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">收款日期</text>
				<picker mode="date" :value="date"  @change="bindDateChange">
						<view class="">{{date}}</view>
				</picker>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">业务员</text>
				<input class="desc" type="text" placeholder="请输入" placeholder-class="placeholder" />元
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">付款人姓名</text>
				<input class="desc" type="text" placeholder="请输入" placeholder-class="placeholder" />元
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">付款人手机号</text>
				<input class="desc" type="text" placeholder="请输入" placeholder-class="placeholder" />元
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">其他账号</text>
				<input class="desc" type="text" placeholder="请输入" placeholder-class="placeholder" />元
			</view>
		</view>
		<!-- 底部 -->
	...
	export default {
		data() {
			...
			return {
				...
				type2Index:0,
				type3:["现金","POS刷卡","转账","支票","挂账","支付宝","微信","置换","其他"],
				type3Index:0,
				date: currentDate,
				time: '12:01',
				date1: currentDate1,
