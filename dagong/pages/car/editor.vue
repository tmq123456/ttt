<template>
	<view style="overflow:auto;overflow-x: hidden">
		...
		<view style="">
			<text class="name" style="font-size: 16px;color: grey;">基本信息</text>
		</view>
		<view class="yt-list">
		  	...
		  	<view class="cate-content" @click.stop.prevent="stopPrevent" @touchmove.stop.prevent="stopPrevent">
		  		<scroll-view scroll-y class="cate-list">
					...
					<view class="yt-list-cell b-b">
						...
						<radio class="radio" type="radio" name="car_type1" value="0" :checked="shui5===0" @click="radio104(0)"/><text style="font-size: 15px;">有</text>
						<radio class="radio" type="radio" name="car_type1" value="1" :checked="shui5===1" @click="radio104(1)"/><text style="font-size: 15px;">无</text>
					</view>
					<view class="yt-list-cell b-b">
			  		...
			  		<view class='upload-image-view'>
						...
						<!-- <view class='image-view' v-if="imageList2">
							<view class="uploader_video">
								<view class="icon iconfont icon-cuo" @tap="previewImage2"></view>
								<video :src="imageList2" class="video" style="width: 55px;height: 50px;"></video>
							</view>
						</view> -->
